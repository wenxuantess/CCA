...
ggplot(data=freddate1, aes(x=DATE, y=TWEXBPA, group=1, label=TWEXBPA)) +
  ...
  # Format the points
  geom_point(colour="black", size=0.2, shape=1, stroke=2) +
  # Label the axis
  ...
  coord_fixed(ratio = 4) +
  #Scale x axis
  scale_x_discrete(breaks=c("06-01","07-01","08-01","09-01","10-01","11-01","12-01","13-01","14-01","15-01","16-01"))
